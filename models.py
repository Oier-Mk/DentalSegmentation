...
class FCN8Model(keras.Model):
    def __init__(self):
        ...
        # Define the architecture the input is 320x320x130 and
        # the output is 320x320x120
        self.conv1 = keras.layers.Conv3D(
            64,
            3,
            activation='relu',
            padding='same',
            input_shape=(320, 320, 130, 1))
        ...
        self.conv5 = keras.layers.Conv3D(
            256,
            3,
            activation='relu',
            padding='same')
        self.conv6 = keras.layers.Conv3D(
            ...
            activation='relu',
            padding='same')
        self.conv7 = keras.layers.Conv3D(
            256,
            3,
            activation='relu',
            padding='same')
        ...
        self.conv8 = keras.layers.Conv3D(
            ...
            activation='relu',
            padding='same')
        self.conv9 = keras.layers.Conv3D(
            512,
            3,
            activation='relu',
            padding='same')
        self.conv10 = keras.layers.Conv3D(
            512,
            3,
            activation='relu',
            padding='same')
        ...
        self.conv11 = keras.layers.Conv3D(
            512,
            3,
            activation='relu',
            padding='same')
        self.conv12 = keras.layers.Conv3D(
            512,
            3,
            activation='relu',
            padding='same')
        self.conv13 = keras.layers.Conv3D(
            512,
            3,
            activation='relu',
            padding='same')
        ...
        self.fc14 = keras.layers.Conv3D(
            4096,
            7,
            activation='relu',
            padding='same')
        self.fc15 = keras.layers.Conv3D(
            4096,
            1,
            activation='relu',
            padding='same')

        self.score_fr = keras.layers.Conv3D(
            1,
            1,
            activation='relu',
            padding='same')
...
class UNETModel(keras.Model):
    def __init__(self):
        ...
        # The input shape is 320x320x130 and the output shape is 320x320x120
